<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid px-4">
      <h1 class="mt-4">Tambah lelang</h1>
      ...
      <div class="container mt-3">
        <form action="<?= base_url('home/aksi_t_lelang') ?>" method="POST" enctype="multipart/form-data">
          <div class="mb-3 mt-3">
            <label for="inputText" class="col-sm-2 col-form-label">id barang</label>
            <div class="col-sm-10">
              <input type="text" required class="form-control" name="id_barang">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="col-sm-10">
              <input type="date" required class="form-control" name="tgl_lelang">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" required class="form-control" name="harga_akhir">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" required class="form-control" name="id_petugas">
            </div>
          </div>
