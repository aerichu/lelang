          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= base_url('home/aksi_e_petugas') ?>" method="POST"> 
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Nama Petugas</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="nama_petugas" value="<?= $satu->nama_petugas ?>">
                  </div>
                </div>
                 <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">ID Level</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="id_level" value="<?= $satu->id_level ?>">
                  </div>
                </div>
                <div class="row mb-3">
